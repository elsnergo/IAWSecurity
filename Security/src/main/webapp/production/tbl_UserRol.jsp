          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Lista de usuarios y roles asignados</h2>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                      <%
                      	ArrayList<Vw_userrol> listaVwUr = new ArrayList<Vw_userrol>();
                      	Dt_userrol dtur = new Dt_userrol();
                      	listaVwUr = dtur.listarUserRol();
	                  %>
                      <thead>
                        <tr>
                          <th>Id</th>
                      ...
                      <tbody>
                      <%
                      	for(Vw_userrol vwur2 :listaVwUr){
                      		String estado = "";
                      		if(vwur2.getEstado()!=3){
                      			estado = "ACTIVO";
                      		}
                      		else{
                      			estado = "INACTIVO";
                      ...
                      %>
                        <tr>
                          <td><%=vwur2.getId_user() %></td>
                          <td><%=vwur2.getNombres()+" "+vwur.getApellidos() %></td>
                          <td><%=vwur2.getUser() %></td>
                          <td><%=vwur2.getRol() %></td>
                          <td><%=estado %></td>
                        </tr>
